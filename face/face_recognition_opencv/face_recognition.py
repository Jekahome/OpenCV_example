...
TODO:модель должна быть предварительно обучена с помощью файла faces_train.py
...
def face_recognition(params):
    try:
        ...
        # list имен в том же порядке как при обучении, так как алгоритм распознавания возвращает индекс label'a, а не имя label'a 
...
# Run:    
# python  /container_data/face/face_recognition_opencv/face_recognition.py